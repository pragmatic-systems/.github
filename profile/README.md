...
## Breadth
With over 20 years in the AI space, spanning chess computing, strategy game control systems, expert systems, hypothesis generators, image and lidar processing, heuristics design and dataset curation, we believe that the machine is part of the journey, and not the ultimate destination.
